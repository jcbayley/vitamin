...
shared_network = ['Conv1D(16,16,2)','Conv1D(16,16,2)','Conv1D(8,8,2)','Flatten()']
# three individual networks designs to come after the shared network
r1_network = ['Linear(32)', 'Linear(32)']
r2_network = ['Linear(32)', 'Linear(32)']
q_network = ['Linear(32)', 'Linear(32)']
